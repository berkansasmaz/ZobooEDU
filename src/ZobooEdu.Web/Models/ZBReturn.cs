...
namespace ZobooEdu.Web.Models
{
    public class ZBReturn
    {
		...
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public List<ZBReturnError> Errors { get; set; } // Biz kullanıcıya mesaj döneceğimiz zaman birden fazla hata mesajı dönüyorsak bu kısma ekliyoruz.
    }

	   public class ZBReturnError
   	 {
        public string Message { get; set; }
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public string InternalMessage { get; set; }
